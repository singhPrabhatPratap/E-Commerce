  ...
  return (
   ...
   <>
    <div className="w-[300px] rounded-md border">
     ...
     {data.map((data)=>(
         <div className="p-4">
         <h1 className="text-lg font-semibold">{data.productBrand}</h1>
         <h1 className="text-lg font-semibold">{data.productType}</h1>
         <h1 className="text-lg font-semibold">{data.productPrice}</h1>
         <h1 className="text-lg font-semibold">{data.productRating}</h1>
