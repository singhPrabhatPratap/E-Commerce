...
export default function cardDet() {
  let { show } = useContext(Usercontext);
  // console.log(show)
  return (
        ...
        <div className="mb-9 pt-4 md:px-6 md:pt-7 lg:mb-2 lg:p-8 2xl:p-10 2xl:pt-10">
          <div className="items-start justify-between lg:flex lg:space-x-8">
            ...
            <div className="flex shrink-0 flex-col lg:w-[430px] xl:w-[470px] 2xl:w-[480px]">
              <div className="pb-5">
                <h2 className="text-lg font-semibold md:text-xl xl:text-2xl">{show.productDesc}</h2>
                <p className="mt-4 font-semibold">₹ {show.productPrice}</p>
              </div>
